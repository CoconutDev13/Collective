...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!sendChannel) {
            return interaction.reply({content: 'There was an error! Try again later.',ephermal: true});
        } else {
            return interaction.reply({content: 'Verification channel was succesfully set!',ephermal: true});
        }
    },
};