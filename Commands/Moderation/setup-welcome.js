const {Message, Client, SlashCommandBuilder, PermissionFlagsBits, WelcomeChannel} = require("discord.js");
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        welcomeSchema.findOne({Guild: interaction.guild.id}, async (err, data) => {
            ...
            interaction.reply({content: 'Succesfully created a welcome message'});
        })
    }
}